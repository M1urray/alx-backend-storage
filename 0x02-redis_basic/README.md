...
+ [x] 1. **Reading from Redis and recovering original type**[exercise.py](exercise.py) contains a Python script with the following updates to the previous task:
...
+ [x] 2. **Incrementing values**[exercise.py](exercise.py) contains a Python script with the following updates to the previous task:
...
+ [x] 3. **Storing lists**[exercise.py](exercise.py) contains a Python script with the following updates to the previous task:
...
+ [x] 5. **Implementing an expiring web cache and tracker**[web.py](web.py) contains a Python script that meets the following requirements:
